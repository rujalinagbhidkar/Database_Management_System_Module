...
-- QUE4
UPDATE employees SET employee_id = 'not available' where department_id = 80 and commission_pct < 20;                  

-- QUE5
UPDATE employees SET employee_id = 'not available' where department_id < 50;
