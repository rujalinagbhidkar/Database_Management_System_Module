...
-- QUE27
SELECT FIRST_NAME FROM employees where last_name LIKE '%son';
...
-- QUE45
SELECT * FROM employees where hire_date between '1995-01-01' and '2005-12-31';

-- QUE46
SELECT * FROM employees where salary > 5000 and department_id not in (50);
